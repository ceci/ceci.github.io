...
\begin{itemize}
\item{\textbf{Caelum} (March/2008 - September/2016) \hfill \textbf{Sao Paulo -- Brazil}\\
	\indent{Caelum is a well known professional training group in Brazil, composed of premium training sessions (Caelum), online courses (Alura) and a publisher (Casa do Código).

	\begin{itemize}
		\item{\textbf{Coach and Culture Champion}\\
			Coached teams and individuals helping them become more effective and take intentional actions towards solving their challenges and doubts. Maintained and evolved the company culture while it grew from 18 to 130 employees. Lead the team responsible for building the company's ERP jugling coding and building new learderships.
		}

		\item{\textbf{Instructor}\\
			Taught (this many) students on topics ranging from Programming Languages to Continuous Deployment. Created the company's Agile courses and delivered trainings all over Brazil and also in Mozambique. Created the online platform Scrum course, which has been watched by 8.5k+ people and graded 9.2 out of 10. Trained a number of successful trainers in didatics.
		}

		\item{\textbf{Agile and Consultant Mentor}\\
