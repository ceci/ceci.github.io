...
\item{\textbf{ThoughtWorks} (October/2016 - current) \hfill \textbf{Sao Paulo -- Brazil}
	\begin{itemize}
		\item{\textbf{Lead Consultant}\\
			Worked as a developer and consultant helping different clients reduce operation costs, expand their market, and take smarter decisions about their own work force, through agile development of applications. [how do I tell the story of what practices, architectures and techniques I am comfortable with...]
		}
	\end{itemize}
}

\item{\textbf{Caelum} (July/2007 - September/2016) \hfill \textbf{Sao Paulo -- Brazil}\\
